...
FEATURE_ROWS = [
    ...
    [
        ...
        "Solid",
        "WhatsApp",
        "Chat finance umum yang dibatasi konteks fitur aplikasi.",
        "general-chat-service.ts",
        "No",
        "Bisa diperdalam lagi untuk Q&A berbasis riwayat user tanpa membuka modul saran khusus.",
    ],
    [
        11,
        ...
        "report-service.ts; recurring-expense-service.ts",
        "No",
...
MODULE_ROWS = [
    ...
    [
        ...
        "Report summary, analytics, health score, monthly PDF.",
        "report-service.ts; monthly-report-pdf-service.ts",
    ],
    [
        "Planning",
