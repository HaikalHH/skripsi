...
vi.mock("@/lib/services/reporting/report-builder", () => ({
  getUserReportData: hoisted.getUserReportData,
  buildReportText: hoisted.buildReportText
}));

vi.mock("@/lib/services/reporting/monthly-pdf", () => ({
  buildMonthlyReportPdfAttachment: hoisted.buildMonthlyReportPdfAttachment
}));

import { buildReportResponse, toReportReplyBody } from "@/lib/inbound/reports/report";
